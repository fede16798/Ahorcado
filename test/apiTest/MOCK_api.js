...
const palabras = [
  {"palabra": "mock","definicion":"Se llaman objetos simulados (pseudoobjetos, mock object, objetos de pega) a los objetos que imitan el comportamiento de objetos reales de una forma controlada."},
                  ];
// ruta
